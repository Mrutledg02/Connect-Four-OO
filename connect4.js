...
class Game {
  constructor(p1, p2, HEIGHT = 6, WIDTH = 7) {
    ...
    this.width = WIDTH;
    this.height = HEIGHT;
    this.currPlayer = p1 //let player 1 go first
    this.makeBoard();
    this.makeHtmlBoard();
  ...
  makeHtmlBoard() {
    ...
    //store a reference (clickable area to the handleClick bound function)
  ...
  //Add a restartGame method to restart the game
  restartGame() {
    //Clear the board and reset any game variables
    this.board = [];
    this.isGameOver = false;
